    ...
    <div class="cuerpo">
        <div class="id">
            <?php
                ...
                $consulta = mysqli_query($conexion, "SELECT id FROM preguntasdb.preguntassec");

                while ($fila = mysqli_fetch_assoc($consulta))
                {echo "<a href='preguntadb.php?id=".$fila['id']."&user=$nom&pass=$pass' class='numero' target='frame1'>".$fila["id"]."</a>";}
